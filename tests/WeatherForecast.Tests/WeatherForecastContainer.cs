...
public sealed class WeatherForecastContainer : HttpClient, IAsyncLifetime
{
    ...
    })
  {
    ...
    const string connectionString = $"Server={weatherForecastStorage};User Id={MsSqlBuilder.DefaultUsername};Password={MsSqlBuilder.DefaultPassword};Database={MsSqlBuilder.DefaultDatabase};TrustServerCertificate=True";
